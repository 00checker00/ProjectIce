...
public abstract class Families
{
    ...
    @NotNull
    public static final Family playerCharacter = Family.all(TransformComponent.class, TextureComponent.class, AnimationComponent.class, BreathComponent.class, ControlComponent.class).exclude(InvisibilityComponent.class).get();
    @NotNull
    public static final Family camera = Family.all(CameraComponent.class).exclude(DisabledComponent.class).get();
    @NotNull
    public static final Family breathing = Family.all(BreathComponent.class, IdleComponent.class).exclude(InvisibilityComponent.class, DisabledComponent.class).get();
    @NotNull
    ...
    @NotNull
    public static final Family controllable = Family.all(ControlComponent.class, TextureComponent.class, TransformComponent.class).exclude(DisabledComponent.class).get();
}
