 ...
 * @author stbachmann
 * @author Nathan Sweet */
public class FilledPolygonShapeRenderer implements Disposable
{
    ...
    public FilledPolygonShapeRenderer()
    {
        this(5000);
    }

    public FilledPolygonShapeRenderer(int maxVertices)
    {
        this(maxVertices, null);
    }

    public FilledPolygonShapeRenderer(int maxVertices, ShaderProgram defaultShader)
    {
    ...
    public void polygon(float[] vertices, int offset, int count)
    {
        ...
        {
            ShortArray arrRes = triangulator.computeTriangles(vertices, offset, count);
